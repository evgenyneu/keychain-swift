## ❗️❗️❗️Known serious issues ❗️❗️❗️
...
In addition, [users experienced](https://github.com/evgenyneu/keychain-swift/issues/98) random carashes when storing text in Keychain.
